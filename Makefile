...
# qwen35 gpu_fused=0: 现阶段 CUDA 只加载权重, transformer 仍走 CPU(日志 cuda: skip GPU transformer)
chat-qwen3.8-27b-cuda: cuda $(Q3_27B_LLF)
